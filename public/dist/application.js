...
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('subregions');'use strict';
// Use Applicaion configuration module to register a new module
  ...
  function ($scope, $interval, _, composer) {
    ...
    angular.extend($scope, {
      ...
      activeSamples: function () {
        var maxBeats = 48, beatsSum, samples = $scope.selectedInstrument.samples, pageComplete = false;
        $scope.nextSample = null;
        if ($scope.startSample)
          samples = samples.slice(samples.indexOf($scope.startSample));
        var activeSamples = _.reduce(samples, function (memo, sample) {
            if (pageComplete)
              return memo;
            beatsSum = _.reduce(memo, function (m, s) {
              return m + s.beats;
            }, 0);
            if (beatsSum < maxBeats && beatsSum + sample.beats <= maxBeats)
              return memo.concat(sample);
            pageComplete = true;
      ...
      updateCursor: function () {
        var grid = angular.element('.track-grids'), cursor = angular.element('.timeline-cursor'), position = composer.playProgress(), scrollMargin = 50;
  ...
  function (composer, TracksConfig, _) {
    return {
      ...
      link: function postLink(scope, element, attrs) {
        var instrumentName = scope.instrument.toLowerCase(), gridSelector = '.track-grid.' + instrumentName + ' .track-grid-inner', tracked = scope.track !== undefined;
        angular.extend(scope, {
          indexer: function () {
            var samples = _.where(TracksConfig.byName(scope.instrument).samples, {
                beats: scope.sample.beats,
                group: scope.sample.group
              });
            var sample = _.findWhere(samples, {
                file: scope.sample.file,
                beats: scope.sample.beats
              });
          ...
          dragToGrid: function (event, ui) {
            var helper = angular.element(ui.helper), offset = scope.gridOffset(), beatSize = composer.grid.beatSize, magicNumber = tracked ? 0 : 16;
            if (helper.data('grid')) {
              ui.position.left = Math.floor(ui.position.left / beatSize) * beatSize - Math.floor((offset.left - element.offset().left) % beatSize) - magicNumber;
...
angular.module('composer').directive('trackDock', [
  '_',
  'composer',
  function (_, composer) {
    return {
...
angular.module('composer').directive('trackGrid', [
  'composer',
  function (composer) {
    return {
...
angular.module('composer').factory('AudioContext', [
  '$window',
  function ($window) {
  ...
  function (_, TracksConfig, audioContext, $rootScope) {
    ...
    SampleTrack.prototype.moveSample = function (sample, newPos) {
      var sampleToMove = _.find(this.samplesBuffer, function (sampleBuffer) {
          return sample.file === sampleBuffer.file && sample.pos === sampleBuffer.pos;
        });
    ...
    angular.extend(TrackManager.prototype, {
      ...
      duration: function () {
        return _.max(this.tracks, function (track) {
    ...
    return {
      ...
      createTrack: function (name) {
        ...
        return trackManager.createTrack(name, instrument.samples, instrument.sampleComposition);
      },
      playProgress: function () {
...
angular.module('composer').factory('TracksConfig', [
  '_',
  function (_) {
    var tracksConfig = [
        {
          ...
          samples: [
            {
              beats: 2,
              file: 'Quena-2T-Cel1-01',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-02',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-03',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-04',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-05',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-06',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-07',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-08',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-09',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel1-10',
              group: 1
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-01',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-02',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-03',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-04',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-05',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-06',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-07',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-08',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-09',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel2-10',
              group: 2
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-01',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-02',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-03',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-04',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-05',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-06',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-07',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-08',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-09',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel3-10',
              group: 3
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-01',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-02',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-03',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-04',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-05',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-06',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-07',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-08',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-09',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel4-10',
              group: 4
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-01',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-02',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-03',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-04',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-05',
              group: 5
            },
            {
              beats: 2,
            ...
            {
              beats: 2,
              file: 'Quena-2T-Cel5-07',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-08',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-09',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel5-10',
              group: 5
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-01',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-02',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-03',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-04',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-05',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-06',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-07',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-08',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-09',
              group: 6
            },
            {
              beats: 2,
              file: 'Quena-2T-Cel6-10',
              group: 6
            },
            {
              beats: 4,
            ...
            {
              beats: 4,
              file: 'Quena-4T-Final-B-01'
            },
            {
              beats: 4,
              file: 'Quena-4T-Final-B-02'
            },
            {
              beats: 4,
              file: 'Quena-4T-Final-B-03'
            },
            {
              beats: 4,
              file: 'Quena-4T-Final-B-04'
            },
            {
              beats: 8,
              file: 'Quena-8T-Final-AB'
            }
          ],
          sampleComposition: [
            {
        ...
        },
        {
          ...
          samples: [
            ...
            {
              beats: 4,
              file: 'Char-4T-Final-A'
            },
            {
              beats: 4,
              file: 'Char-4T-Final-B-01'
            },
            {
              beats: 4,
              file: 'Char-4T-Final-B-02'
            },
            {
              beats: 4,
              file: 'Char-4T-Final-B-03'
            },
            {
              beats: 4,
              file: 'Char-4T-Final-B-04'
            },
            {
              beats: 8,
              file: 'Char-8T-Final-AB'
            },
            {
              beats: 20,
              file: 'Char-20T-Intro-01'
            },
            {
              beats: 20,
              file: 'Char-20T-Intro-02'
            },
            {
              beats: 20,
              file: 'Char-20T-Intro-03'
            }
          ],
          sampleComposition: [
            {
  ...
  function ($scope, $stateParams, $location, regionsConfig, Authentication, Regions, openModal, fileupload, Instruments, Subregions) {
    ...
    $scope.findOne = function () {
      var Region = Regions.get({ regionId: $stateParams.regionId }, function () {
          $scope.regionInstruments = Instruments.query({
