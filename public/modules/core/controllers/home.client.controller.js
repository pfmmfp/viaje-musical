...
angular.module('core').controller('HomeController', ['$scope', '$rootScope', '$location', 'Authentication', 'openModal', 'ImagePreloadFactory', 'composer', 'fxAudioFactory', '_',
	function($scope, $rootScope, $location, Authentication, openModal, ImagePreloadFactory, composer, fxAudioFactory, _)
    {
